...
\begin{tikzpicture}[every node/.style={minimum size=1cm, font=\tiny},on grid]
	...
	\draw[-latex,ultra thick,dotted] (4,5) node[right]{Search Area}
         to[out=180,in=90] (0.6,3.7);
    \draw[-latex,ultra thick,dotted] (4,4) node[right]{$i$th Block Matching} to[out=180,in=90] (0.2,2.2); 
    \node at (7.5,3.25) {Candidate ($C(x_i,y_i)$)};
    \draw[-latex,ultra thick,dotted] (3,1) node[right]{Anchor Frame}
